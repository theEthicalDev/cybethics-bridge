...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'local.hero.title': 'Location Central Switzerland: Software & Automation',
    'local.hero.subtitle': 'Professional software development, automation, process optimization & DevOps in Lucerne, Zug and the surrounding area of Central Switzerland.',
    'local.services.title': 'Our services in Central Switzerland',
    'local.services.subtitle': 'As a partner from the region, we offer unique advantages for companies in Central Switzerland.',
    'local.advantages.title': 'Advantages of a local IT partner',
    'local.advantages.subtitle': 'As a partner from the region, we offer unique advantages for companies in Central Switzerland.',
    'local.advantages.personal.title': 'Personal care',
    'local.advantages.personal.description': 'Direct contact and regular personal meetings instead of anonymous support hotlines.',
    'local.advantages.response.title': 'Short response times',
    'local.advantages.response.description': 'Quick response to inquiries and short travel times for on-site appointments.',
    'local.advantages.network.title': 'Local network',
    'local.advantages.network.description': 'We know someone: Access to local partners and resources in Central Switzerland.',
    'local.description': 'As a local partner for software development, automation, and DevOps in Central Switzerland, we offer tailored solutions for companies in Lucerne, Zug, Zurich, Schwyz, and the surrounding area.',
    'local.description2': 'Our proximity to you enables quick response times and a deep understanding of local business requirements.',
    'local.title': 'Software Development in Central Switzerland',
    'local.areas.title': 'Our Areas of Activity',
    'local.areas.de': 'Available throughout German-speaking Switzerland',
    'local.areas.remote': 'Remote work worldwide',
  },
  de: {
    'nav.home': 'Startseite',
    ...
    'services.detailDescription': 'Entdeckt unser umfassendes Dienstleistungsangebot, das darauf abzielt, Euer Unternehmen zu' +
      ' transformieren',
    'services.software.benefit1': 'Massgeschneiderte Lösungen, die auf Eure Geschäftsziele abgestimmt sind',
    ...
    'faq.solutions.database.benefits.5': 'Starke Sicherheitsmassnahmen schützen sensible Informationen.',
    ...
    'faq.solutions.security.benefits.3': 'Regelmässige Sicherheitsupdates minimieren Risiken.',
    ...
    'local.advantages.subtitle': 'Als Partner aus der Region bieten wir einzigartige Vorteile für Unternehmen in der Zentralschweiz.',
    'local.advantages.personal.title': 'Persönliche Betreuung',
    'local.advantages.personal.description': 'Direkter Kontakt und regelmässige persönliche Treffen statt anonymer Support-Hotlines.',
    'local.advantages.response.title': 'Kurze Reaktionszeiten',
    'local.advantages.response.description': 'Schnelle Reaktion auf Anfragen und kurze Anfahrtswege für Vor-Ort-Termine.',
    'local.advantages.network.title': 'Lokales Netzwerk',
    'local.advantages.network.description': 'Wir kennen da jemanden: Zugriff auf lokale Partner und Ressourcen in der Zentralschweiz.',
    'local.description': 'Als lokaler Partner für Softwareentwicklung, Automatisierung und DevOps in der Zentralschweiz bieten wir massgeschneiderte Lösungen für Unternehmen in Luzern, Zug, Zürich, Schwyz und Umgebung.',
    'local.description2': 'Unsere Nähe zu Ihnen ermöglicht schnelle Reaktionszeiten und ein tiefes Verständnis der lokalen' +
      ' Geschäftsanforderungen.',
    'local.title': 'Software Entwicklung in der Zentralschweiz',
    'local.areas.title': 'Unsere Tätigkeitsgebiete',
    'local.areas.de': 'Verfügbar in der gesamten Deutschschweiz',
    'local.areas.remote': 'Remote Arbeit weltweit',
  }
};
