                ...
                <Card className="border-0 shadow-lg">
                  ...
                  <CardContent className="space-y-8">
                    ...
                    <div>
                      ...
                      <div className={`grid grid-cols-2 md:grid-cols-${Object.values(appTypes).length} gap-4`}>
                    ...
                    <div className="bg-primary/5 p-6 rounded-lg">
                      <div className="text-center">
                        ...
                        <p className="text-sm text-text/70 mb-4">
                          <strong>{t('pricing.calculator.disclaimer_bold')}</strong>
              ...
              <div className="sticky top-32 w-80">
                <div className="bg-white border-2 border-primary/20 rounded-lg p-6 shadow-lg">
                  <div className="text-center">
                    ...
                    <Link to="/contact">
                      <Button className="bg-primary hover:bg-primary/90 text-wrap w-full h-auto">
                        {t('pricing.calculator.cta')}
                      </Button>
                    </Link>
                  </div>
