...
const items = ['web', 'backend', 'tools', 'devops'];
const benefitKeys = ['tailored', 'competitive', 'ownership', 'scalable'];
const benefitIcons = [Target, Trophy, Shield, Scaling];
const processSteps = ['step1', 'step2', 'step3', 'step4'];
const challengeKeys = ['gut'];
const projectIds = [10, 50, 300, 5];
  ...
  return (
    <div className="min-h-screen pt-24 pb-16">
      ...
      <section className="pt-12 pb-12 md:py-24 bg-gradient-to-br from-violet-50/50 via-background to-muted/30">
        <div className="container">
          <div className="max-w-3xl mx-auto text-center animate-fade-up">
            <div className="inline-flex items-center gap-3 px-6 py-3 bg-violet-500/10 rounded-full mb-8 border border-violet-500/20">
              <Code className="h-5 w-5 text-violet-600" />
              <span className="text-sm font-semibold text-violet-600">{t('servicePage.develop.title')}</span>
            </div>
            <h1 className="text-4xl md:text-5xl font-bold mb-6">{t('servicePage.develop.subtitle')}</h1>
            <p className="text-xl text-muted-foreground leading-relaxed">{t('servicePage.develop.heroDescription')}</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24">
        <div className="container">
          <h2 className="text-3xl font-bold mb-12 text-center">{t('servicePage.develop.whatWeDo')}</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {items.map((item, index) => (
              <div key={item} className="p-8 rounded-2xl bg-card border border-border/50 shadow-soft hover:shadow-medium transition-all duration-300 hover:-translate-y-1 animate-fade-up" style={{ animationDelay: `${index * 100}ms` }}>
                <h3 className="text-xl font-semibold mb-3">{t(`servicePage.develop.items.${item}.title`)}</h3>
                <p className="text-muted-foreground leading-relaxed">{t(`servicePage.develop.items.${item}.description`)}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 md:py-24 bg-muted/30">
        <div className="container">
          <h2 className="text-3xl font-bold mb-12 text-center">{t('servicePage.develop.challengesTitle')}</h2>
      ...
      <section className="py-16 md:py-24">
        <div className="container">
          <h2 className="text-3xl font-bold mb-12 text-center">{t('servicePage.develop.benefitsTitle')}</h2>
            ...
            {benefitKeys.map((key, index) => {
              ...
              return (
                <div key={key} className="text-center p-6 rounded-2xl bg-card border border-border/50 shadow-soft animate-fade-up" style={{ animationDelay: `${index * 100}ms` }}>
                  ...
                  <h3 className="font-semibold mb-2">{t(`servicePage.develop.benefits.${key}.title`)}</h3>
                  <p className="text-sm text-muted-foreground">{t(`servicePage.develop.benefits.${key}.description`)}</p>
                </div>
              );
            })}
          </div>
      ...
      <section className="py-16 md:py-24 bg-muted/30">
        <div className="container">
          <h2 className="text-3xl font-bold mb-12 text-center">{t('servicePage.develop.processTitle')}</h2>
          <div className="max-w-3xl mx-auto space-y-8">
            {processSteps.map((step, index) => (
              <div key={step} className="flex items-start gap-6 animate-fade-up" style={{ animationDelay: `${index * 100}ms` }}>
                ...
                <div className="pt-1">
                  <h3 className="text-lg font-semibold mb-1">{t(`servicePage.develop.process.${step}.title`)}</h3>
                  <p className="text-muted-foreground">{t(`servicePage.develop.process.${step}.description`)}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-16 md:py-24">
        <div className="container">
          <h2 className="text-3xl font-bold mb-12 text-center">{t('servicePage.develop.projectsTitle')}</h2>
      ...
      <section className="py-12 bg-muted/30">
        <div className="container text-center">
          <h3 className="text-lg font-semibold mb-4">{t('servicePage.develop.technologiesTitle')}</h3>
          <div className="flex flex-wrap justify-center gap-3">
            {t('servicePage.develop.technologies').split(', ').map((tech) => (
